...
def parse_args() -> argparse.Namespace:
    ...
    fail_group.add_argument("--fail-on-attention", action="store_true", help="exit 2 when drift or review due is found")
    fail_group.add_argument("--fail-on-due", action="store_true", help="exit 2 only when a documentation review is due")
